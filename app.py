...
tokenizer = AutoTokenizer.from_pretrained("gpt2-adstext/gpt2-adstext")
model = AutoModelWithLMHead.from_pretrained("gpt2-adstext/gpt2-adstext", return_dict=True)
...
@app.route("/gpt2-ads/<type>", methods=['POST'])
def gpt2_word(type):
